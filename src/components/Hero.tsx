...
const Hero = memo(() => {
  ...
  return (
    <main className="relative min-h-screen bg-transparent flex items-center overflow-hidden transition-colors duration-300 pt-40 pb-16" role="main" aria-label="Spendora Workshop Hero Section">
      <RobotBackground />
