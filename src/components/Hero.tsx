            ...
            <div className="relative max-w-4xl mx-auto">
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-start">
                ...
                <div className="relative">
                  <div className="new-liquid-glass-surface rounded-3xl p-8 shadow-large relative overflow-hidden">
                    {/* Background pattern */}
                ...
                <div className="space-y-6">
                  {/* Location Card */}
                  <div className="new-liquid-glass-surface rounded-2xl p-6 shadow-medium">
                    <div className="text-center space-y-4">
