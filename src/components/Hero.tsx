...
import { ChartLine, Store, ArrowRight, Coins, Bitcoin, Heart, Camera, MapPin } from "lucide-react";
...
const Hero = memo(() => {
  ...
  return (
    <section className="relative min-h-[90vh] pt-24 pb-16 overflow-hidden flex flex-col justify-center">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 pb-2 max-w-3xl mx-auto">
            ...
            <button
              ...
              className="p-5 rounded-2xl border border-blue-500/30 bg-blue-500/5 hover:bg-blue-500/10 transition-all text-left group cursor-pointer flex flex-col justify-between"
            >
              <div>
                <div className="text-3xl font-black bg-gradient-to-r from-blue-500 to-indigo-500 bg-clip-text text-transparent">
                  300+
                </div>
            ...
            {/* Stat 2 */}
            <div className="p-5 rounded-2xl border border-emerald-500/30 bg-emerald-500/5 text-left">
              <div className="text-3xl font-black bg-gradient-to-r from-emerald-500 to-teal-500 bg-clip-text text-transparent">
                3
              </div>
              <div className="text-sm font-bold text-foreground">Events</div>
              <div className="text-xs text-muted-foreground">Hosted</div>
            </div>

            {/* Stat 3 */}
            <div className="p-5 rounded-2xl border border-purple-500/30 bg-purple-500/5 text-left">
              <div className="text-3xl font-black bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent">
                5+
              </div>
          ...
          <div className="pt-4 space-y-4">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                ...
                className="w-full sm:w-auto px-8 py-6 rounded-full text-lg font-bold shadow-xl hover:scale-105 transition-all bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white"
              >
        ...
        <div className="mt-16 max-w-4xl mx-auto grid md:grid-cols-2 gap-8 items-stretch">
          {/* Live Timer */}
          <div className="p-6 sm:p-8 rounded-3xl border border-border bg-card/60 backdrop-blur-md shadow-lg flex flex-col justify-center">
            <LiveEventTimer
              isActive={true}
          ...
          <div className="space-y-4 flex flex-col justify-between">
            {/* Location Card */}
            <div className="p-6 rounded-3xl border border-border bg-card/60 backdrop-blur-md shadow-lg space-y-4">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-2xl bg-red-500/10 border border-red-500/20 text-red-500 flex items-center justify-center font-bold">
            ...
            <div className="p-6 rounded-3xl border border-border bg-card/60 backdrop-blur-md shadow-lg">
              <h4 className="text-sm font-bold text-muted-foreground uppercase tracking-wider mb-3">What's Included</h4>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-sm font-semibold text-foreground">
        ...
        <div className="mt-24 max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-2">Explore Our Workshop Topics</h2>
            <p className="text-muted-foreground">Click on any card to learn more about each topic</p>
          </div>
