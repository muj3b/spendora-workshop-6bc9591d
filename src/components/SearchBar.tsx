...
const SearchBar = () => {
  ...
  const searchData: SearchResult[] = useMemo(
    () => [
      ...
      { title: 'Doon Public School Workshop', content: 'Auditorium financial literacy session for Classes XI & XII in Panchkula, India', url: '/gallery#doon-school', type: 'section' },
      { title: 'Sri Girdhar Techno School', content: '7 photos and 5 interactive workshop videos from rural India outreach', url: '/gallery#indian-school', type: 'section' },
      { title: 'Ram Krishna Dwarika School', content: 'Classroom personal finance seminar in Patna, Bihar, India', url: '/gallery#ram-krishna-school', type: 'section' },
      { title: 'Session 1: Intro to Investing', content: 'Stock market history, index funds, and custodial accounts at R.H. Stafford Library', url: '/gallery#session-1', type: 'section' },
      ...
      { title: 'Compound Interest Calculator', content: 'Interactive simulator comparing starting at 16 vs waiting until 26', url: '/#calculator', type: 'section' },
