      ...
      <div className="max-w-5xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
        ...
        <div>
          ...
          <ul className="space-y-3.5 text-slate-600 dark:text-zinc-400 text-sm font-medium">
            ...
            <li><Link to="/audiobook" className="hover:text-emerald-700 dark:hover:text-white transition-colors">Audio Course</Link></li>
            <li><a href="/#partners" className="hover:text-emerald-700 dark:hover:text-white transition-colors">Partners</a></li>
            <li><a href="/#press" className="hover:text-emerald-700 dark:hover:text-white transition-colors">Press</a></li>
